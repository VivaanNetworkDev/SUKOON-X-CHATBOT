...
SOURCE_READ = f"**ʜᴇʏ, ᴛʜᴇ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ᴏғ [{app.name}](https://t.me/{app.username}) 𝐂ᴀɴ ʙᴇ 𝐆ᴇᴛ.**\n**𝐅ʀᴏᴍ 𝐌ʏ 𝐃ᴇᴠ ✯**\n**──────────────────**\n**𝐇ᴇʀᴇ ɪ𝐬 𝐇ɪ𝐬 𝐈ᴅ 𝐁ᴀʙʏ [𝐒𝐈𝐃](https://t.me/EliteSid)**\n**──────────────────**\n**ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴛʜᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴀᴛ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/{SUPPORT_GROUP}).\n<b> ©️ @{OWNER_USERNAME} </b>"

ADMIN_READ = f"[VivaanNetwork](https://t.me/VivaanNetwork)"
